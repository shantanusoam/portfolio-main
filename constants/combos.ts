...
export const combos: ComboGroup[] = [
  ...
  },
  {
    ...
    label: 'Systems Combo',
    skills: [
      { name: 'Node.js', proficiency: 80, proofProjectIds: ['arnomis', 'voicebox-ai'] },
      ...
      { name: 'Python', proficiency: 70, proofProjectIds: ['hardware-prototypes', 'voicebox-ai'] },
  ...
  },
  {
    ...
    label: 'AI Combo',
    skills: [
      { name: 'OpenAI', proficiency: 80, proofProjectIds: ['maan', 'vampire', 'serious', 'voicebox-ai'] },
      ...
      { name: 'AI Agents', proficiency: 70, proofProjectIds: ['voicebox-ai'] },
