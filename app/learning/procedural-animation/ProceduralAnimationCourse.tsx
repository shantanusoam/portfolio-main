...
import { TUTORIALS } from "./courseTutorials";
...
const LESSONS: readonly Lesson[] = [
  {
    ...
    promise:
      "Separate a target, a mover and a body before touching a single fin.",
    minutes: 18,
    paragraphs: [
    ...
    principle:
      "Goal → steering → locomotion → rendering. Keep the layers replaceable.",
    psychology:
      "People readily infer agency from simple shapes when trajectories look goal-directed. That makes direct pursuit powerful—but also attention-hungry. Use it deliberately, not as ambient noise.",
    exercise:
      "Pause the lab, take pointer control, then move the target in one clean line. Can you predict where the head will stop?",
...
renderer.draw(rig);`,
    ...
    quiz: {
      ...
      options: [
        {
          label: "The root trajectory",
          correct: true,
          feedback: "Yes. Make intent legible before adding anatomy.",
        },
        {
          label: "More fins",
          correct: false,
          feedback: "Fins amplify motion; they do not repair a bad controller.",
        },
        {
          label: "Random noise",
          correct: false,
          feedback: "Noise is texture, not intent.",
        },
      ],
    },
  },
  {
    ...
    promise:
      "Build position, velocity and acceleration into a predictable mover.",
    minutes: 22,
    paragraphs: [
    ...
    principle:
      "Integrate velocity over time; derive facing from motion, not wishful intent.",
    psychology:
      "Prediction is comfort. When acceleration and facing agree, the viewer can forecast the next instant; mismatched cues feel slippery or mechanical.",
    exercise:
      "Lower response, then raise damping. Find the slowest motion that still feels intentional rather than asleep.",
...
if (length(velocity) > epsilon) heading = atan2(vy, vx);`,
    ...
    quiz: {
      ...
      options: [
        {
          label: "To prevent unstable spinning",
          correct: true,
          feedback: "Correct. Direction is undefined at zero velocity.",
        },
        {
          label: "To increase frame rate",
          correct: false,
          feedback: "It helps visual stability, not rendering cost.",
        },
        {
          label: "To make links longer",
          correct: false,
          feedback: "Heading and link length are separate constraints.",
        },
      ],
    },
  },
  {
    ...
    psychology:
      "Small, consistent overshoot reads as liveliness. Unbounded or unrelated oscillation reads as loss of control—and competes with the page’s actual information.",
    exercise:
      "Use Break it, then repair only damping. Notice what it fixes and what still requires angle or length limits.",
...
position += velocity * dt;`,
      ...
      options: [
        {
          label: "Damping",
          correct: true,
          feedback: "Right. Damping dissipates energy.",
        },
        {
          label: "Body color",
          correct: false,
          feedback: "Appearance can mask, but cannot solve, oscillation.",
        },
        {
          label: "Joint count",
          correct: false,
          feedback: "More joints change resolution, not root energy.",
        },
      ],
    },
  },
  {
    ...
    psychology:
      "Common fate—parts moving as one coherent unit—helps a viewer group points into a single creature. Broken spacing disrupts that perceptual unity immediately.",
    exercise:
      "Move from 5 to 24 joints while keeping overall length roughly constant. Find where extra resolution stops improving the silhouette.",
  ...
  joints[i] = joints[i - 1] + direction * segmentLength;
    ...
    quiz: {
      ...
      options: [
        {
          label: "The head is controlled and motion propagates backward",
          correct: true,
          feedback: "Exactly—the dependency has a clear direction.",
        },
        {
          label: "Canvas only draws left to right",
          correct: false,
          feedback: "Rendering order is unrelated.",
        },
        {
          label: "It creates random motion",
          correct: false,
          feedback: "The solve is deterministic.",
        },
      ],
    },
  },
  {
    ...
    promise:
      "Use regional angle limits to trade stiffness for organic curvature.",
    minutes: 22,
    paragraphs: [
    ...
    psychology:
      "Biological motion feels plausible when flexibility is distributed meaningfully. Viewers may not name the rule, but they notice when a ‘skull’ bends like rope.",
    exercise:
      "Set 60°, then 8°. The first folds; the second becomes rigid. Find a head-safe value that still lets the tail finish the turn.",
...
angle = previous + clamp(delta, -limit, limit);`,
    ...
    quiz: {
      ...
      options: [
        {
          label: "Self-folding and sharp kinks",
          correct: true,
          feedback: "Correct. Length says nothing about curvature.",
        },
        {
          label: "Color contrast",
          correct: false,
          feedback: "That belongs to rendering.",
        },
        {
          label: "Pointer ownership",
          correct: false,
          feedback: "That belongs to behavior and interaction state.",
        },
      ],
    },
  },
  {
    ...
    psychology:
      "Stable feature attachment preserves object identity. When eyes or markings drift independently, the visual system reads layers sliding—not one living body.",
    exercise:
      "Change body width without changing the chain. Watch how morphology changes while motion logic remains intact.",
...
right[i] = joint[i] - normal * width(i);`,
    ...
    quiz: {
      ...
      options: [
        {
          label: "In a head-local frame derived from the spine",
          correct: true,
          feedback: "Yes. It then inherits position and rotation coherently.",
        },
        {
          label: "At a fixed viewport coordinate",
          correct: false,
          feedback: "It would detach as the fish moves.",
        },
        {
          label: "At the pointer",
          correct: false,
          feedback: "The pupil may track it; the eye socket should not.",
        },
      ],
    },
  },
  {
    ...
    promise:
      "Add Verlet fins and tails that echo the root without stealing the scene.",
    minutes: 24,
    paragraphs: [
    ...
    principle:
      "Secondary motion receives energy; it does not invent the main action.",
    psychology:
      "Follow-through adds material cues—softness, weight, water resistance. Consistent decay lets the viewer infer what the creature is made of.",
    exercise:
      "Compare low damping with a tight angle limit. Then reverse it. Identify whether the bad feeling comes from stored energy or impossible curvature.",
...
solveDistanceConstraints();`,
    ...
    quiz: {
      ...
      options: [
        {
          label: "Root motion energy",
          correct: true,
          feedback: "Right. The fin should echo the action.",
        },
        {
          label: "Unbounded random values",
          correct: false,
          feedback: "That breaks material continuity.",
        },
        {
          label: "Screen size only",
          correct: false,
          feedback: "Scale matters, but not as the motion source.",
        },
      ],
    },
  },
  {
    ...
    principle:
      "One owner per target; every continuous motion has a visible exit.",
    psychology:
      "Goal-directed pursuit creates a strong sense of animacy and attention. Control changes that intensity from interruption into play.",
    exercise:
      "Take pointer control, then pause. Ask whether the current UI makes the state and the way out obvious without documentation.",
    code: `switch (state) {
...
// Follow starts only after an explicit hit on the creature.`,
    ...
    quiz: {
      question:
        "What is the safest default for a persistent decorative follower?",
      options: [
        {
          label: "Rest until explicitly invited",
          correct: true,
          feedback: "Yes. Motion becomes a user-owned mode.",
        },
        {
          label: "Chase every pointer movement",
          correct: false,
          feedback: "That maximizes involuntary attention capture.",
        },
        {
          label: "Move faster so it ends sooner",
          correct: false,
          feedback: "Speed does not provide control.",
        },
      ],
    },
  },
  {
    ...
    promise:
      "Ship frame-rate-independent motion with fixed steps and bounded work.",
    minutes: 26,
    paragraphs: [
    ...
    psychology:
      "Latency breaks agency. When input and response drift apart, the creature stops feeling like it belongs to the visitor’s action.",
    exercise:
      "Pause for a few seconds, resume, and verify that the chain does not teleport or explode. Then compare the rig overlay at 6 versus 28 joints.",
...
render();`,
    ...
    quiz: {
      ...
      options: [
        {
          label: "To keep a slow frame from creating more slow frames",
          correct: true,
          feedback: "Correct—the spiral of death must be bounded.",
        },
        {
          label: "To change body color",
          correct: false,
          feedback: "Rendering style is separate.",
        },
        {
          label: "To make time physically exact",
          correct: false,
          feedback: "The cap trades lost simulation time for responsiveness.",
        },
      ],
    },
  },
  {
    ...
    promise:
      "Use a repeatable review loop instead of accumulating magic numbers.",
    minutes: 30,
    paragraphs: [
    ...
    psychology:
      "Coherent causes matter more than maximal detail. One readable intention with disciplined follow-through feels more alive than many unrelated effects.",
    exercise:
      "Create one calm preset: no folding, one modest overshoot, clean stop, readable body and a visible way to pause it. Mark the module complete when you can defend every parameter.",
    code: `review([
  ...
  "edge", "tab resume", "reduced motion", "feature off"
    ...
    quiz: {
      ...
      options: [
        {
          label: "Root → constraints → silhouette → secondary detail",
          correct: true,
          feedback: "Exactly. Each stage depends on the previous one.",
        },
        {
          label: "Glow → particles → root",
          correct: false,
          feedback: "That hides causes under effects.",
        },
        {
          label: "Everything simultaneously",
          correct: false,
          feedback: "You lose the ability to attribute changes.",
        },
      ],
    },
  },
...
const STEP_PROGRESS_KEY = "procedural-animation-course-step-progress-v1";
...
export default function ProceduralAnimationCourse() {
        ...
        if (Array.isArray(parsed)) {
          const validStepKeys = new Set(
            LESSONS.flatMap((item) =>
              TUTORIALS[item.id].steps.map((_, index) => `${item.id}:${index}`),
            ),
          );
  ...
  const totalBuildSteps = useMemo(
    () =>
      LESSONS.reduce((sum, item) => sum + TUTORIALS[item.id].steps.length, 0),
    [],
  );
    ...
    <main className={styles.coursePage}>
        ...
        <div className={styles.heroGrid}>
          <div>
            <p className={styles.kicker}>
              Interactive field course · {totalMinutes} minutes ·{" "}
              {totalBuildSteps} code steps
            </p>
            <h1>Procedural animation, from noob to pro.</h1>
            <p className={styles.heroLede}>
              Build one living fish from a dot with copyable TypeScript,
              control-by-control experiments, expected results and real failure
              fixes—then compare it with the system running across this site.
            </p>
          </div>
      ...
      <div className={styles.courseLayout}>
        <aside className={styles.lessonRail}>
          ...
          <Link className={styles.labLink} href="/creature-lab">
            Open full Creature Lab →
          </Link>
        </aside>
        ...
        <article className={styles.lessonArticle}>
          ...
          <div className={styles.articleBody}>
            <div className={styles.conceptDivider}>
              ...
              <p>
                You have changed the behavior and built the code. These notes
                explain why the result works and where the trade-offs live.
              </p>
            </div>
            ...
            <div className={styles.calloutGrid}>
              ...
              <section>
                <span>Why it feels alive</span>
                <p>{lesson.psychology}</p>
              </section>
            </div>
            ...
            <section className={styles.codeBlock}>
              <div>
                <span>Concept recap · pseudocode</span>
                <button
                  type="button"
      ...
      <section className={styles.sources}>
        <div>
          <p className={styles.kicker}>Primary sources behind the course</p>
          <h2>Read past the interface.</h2>
        </div>
        <div className={styles.sourceGrid}>
          <a
            href="https://github.com/argonautcode/animal-proc-anim"
            target="_blank"
            rel="noreferrer"
          >
            <strong>Argonaut Code</strong>
            <span>Open-source constrained animal animation reference</span>
          </a>
          <a
            href="https://www.red3d.com/cwr/papers/1999/gdc99steer.pdf"
            target="_blank"
            rel="noreferrer"
          >
            <strong>Craig Reynolds</strong>
            <span>Steering Behaviors for Autonomous Characters</span>
          </a>
          <a
            href="https://perception.yale.edu/papers/09-Gao-Newman-Scholl-CogPsych.pdf"
            target="_blank"
            rel="noreferrer"
          >
            <strong>Gao, Newman &amp; Scholl</strong>
            <span>The psychophysics of chasing and perceived animacy</span>
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <strong>Aristidou &amp; Lasenby</strong>
            <span>FABRIK inverse-kinematics solver</span>
          </a>
          <a
            href="https://cs.uef.fi/~radum/vwd/lectures/Jakobsen.pdf"
            target="_blank"
            rel="noreferrer"
          >
            <strong>Thomas Jakobsen</strong>
            <span>Verlet integration and positional constraints</span>
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <strong>W3C WAI</strong>
            <span>Pause, stop and hide guidance for moving content</span>
          </a>
        </div>
      </section>
    </main>
